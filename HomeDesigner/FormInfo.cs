...
namespace HomeDesigner
{
    public class FormInfo : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.l1 = new Label();
            this.l1.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            this.l1.AutoSize = true;
            this.l1.Location = new Point(110, 22);
            this.l1.Name = "l1";
            this.l1.Size = new Size(72, 13);
            this.l1.TabIndex = 2;
            this.l1.Text = ":";

            this.l2 = new Label();
            this.l2.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            this.l2.AutoSize = true;
            this.l2.Location = new Point(170, 22);
            this.l2.Name = "l2";
            this.l2.Size = new Size(72, 13);
            this.l2.TabIndex = 2;
            this.l2.Text = ":";


            this.l3 = new Label();
            this.l3.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            this.l3.AutoSize = true;
            this.l3.Location = new Point(0, 20);
            this.l3.Name = "l3";
            this.l3.Size = new Size(72, 13);
            this.l3.TabIndex = 2;
            this.l3.Text = ":";

            this.l4 = new Label();
            this.l4.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            this.l4.AutoSize = true;
            this.l4.Location = new Point(0, 20);
            this.l4.Name = "l4";
            this.l4.Size = new Size(72, 13);
            this.l4.TabIndex = 2;
            this.l4.Text = ":";
          ...
          for(int i=0; i<=23; i++){
            ...
            for(int i=0; i<=59; i++){
                ...
                else
                {
                    ...
                    this.endTextBoxM.Items.Add((object)  i.ToString());
            ...
            this.Controls.Add((Control)this.l1);
            this.Controls.Add((Control)this.l2);
            this.Controls.Add((Control)this.l3);
            this.Controls.Add((Control)this.l4);
