...
namespace HomeDesigner
{
    ...
    public class FormSimulation:Form
    {
        ...
        private TextBox numeroGiorniBox;
        ...
        private void InitializeComponent()
        {
            ...
            this.numeroGiorniBox = new TextBox();
            ...
            this.label1.Location = new Point(18, 82);
            ...
            this.numeroGiorniBox.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            this.numeroGiorniBox.Location = new Point(50, 80);
            this.numeroGiorniBox.Name = "numeroGiorniBox";
            this.numeroGiorniBox.Size = new Size(121, 21);
            this.numeroGiorniBox.TabIndex = 30;
            this.Controls.Add((Control)this.numeroGiorniBox);
            ...
            this.simula.Location = new Point(100, 300);
        ...
        private void buttonSimula_Click(object sender, EventArgs e)
        {
            ...
            if (this.numeroGiorniBox.Text.Equals("")
               )
            {
                MessageBox.Show("Choose a number of the days for the simulation!");
            ...
            else
            {
                ...
                numeroGiorni = Convert.ToInt32(numeroGiorniBox.Text.ToString());
                this.Close();
            }
        }
